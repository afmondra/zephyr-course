...
#define CONFIG_DT_HAS_SNPS_ARCEM_ENABLED 1
...
#define CONFIG_BOARD_TARGET "qemu_arc/qemu_arc_em"
#define CONFIG_QEMU_TARGET 1
#define CONFIG_BOARD_QEMU_ARC 1
#define CONFIG_BOARD_QEMU_ARC_QEMU_ARC_EM 1
#define CONFIG_BOARD_QUALIFIERS "qemu_arc_em"
